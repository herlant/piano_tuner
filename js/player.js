        ...
        if(this.playing) {
            ...
            if(this.left_en){
                ...
                for(var i=1; i<this.n_harmonics+1; i++) { // loop over harmonics
                    this.left_oscillators[i].frequency.value = this.left_f0*(i+1) + Math.sqrt(1+this.left_inharmonicity*Math.pow(i+1,2)); // set harmonic frequency
            ...
            if(this.right_en){
                ...
                for(var i=1; i<this.n_harmonics+1; i++) { // loop over harmonics
                    this.right_oscillators[i].frequency.value = this.right_f0*(i+1) + Math.sqrt(1+this.right_inharmonicity*Math.pow(i+1,2)); // set harmonic frequency
